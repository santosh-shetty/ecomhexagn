...
<div class="container-fluid page-body-wrapper">
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <?php endif; ?>
            <form class="form-sample" action="<?= base_url('admin/brands/brands') ?>" method="post">
                <!-- For get id -->
                <input type="hidden" name="brand_id" class="form-control" value="<?= $brand['brand_id'] ?>">
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="brand_name" class="form-control" placeholder="Enter Brand name here" aria-label="Username" value="<?= $brand['brand_name'] ?>">
                                ...
                                <!-- <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-check mt-0">
                                            <label class="col-form-label">
                                                <input style="margin-right: 10px;" type="radio" name="status" value="1" </?= $brand['status'] == 1 ? "checked" : "" ?>>
                                                Active
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-check mt-0">
                                            <label class="col-form-label">
                                                <input style="margin-right: 10px;" type="radio" name="status" value="0" </?= $brand['status'] == 0 ? "checked" : "" ?>>
                                                In Active
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="exampleTextarea1" rows="4" name="category_desc"><?= $category['category_desc'] ?></textarea>
                                        <script>
